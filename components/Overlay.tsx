...
const Overlay = () => {
  ...
  if (open) {
    return <div className="fixed z-40 inset-0" style={{ backgroundImage: 'url("/xp.jpg")', backgroundRepeat: 'no-repeat', backgroundAttachment: 'fixed', backgroundPosition: 'center', backgroundSize: 'cover' }}>
