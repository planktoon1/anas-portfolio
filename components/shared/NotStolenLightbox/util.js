...
export function getWindowWidth() {
    // return typeof document !== 'undefined' ? document.querySelector(".containerforimage").getBoundingClientRect().width : 0;
    return typeof global.window !== 'undefined' ? global.window.innerWidth : 0;
}

export function getWindowHeight() {
    // return typeof document !== 'undefined' ? document.querySelector(".containerforimage").getBoundingClientRect().height : 0;
